...
__all__ = ['PRIMARY_COLOR', 'ACCENT_COLOR', 'DEFAULT_STYLE', 'centimeter', 'set_style', 'plot_spectra',
           'get_y_by_order', 'summary_plot', 'plot_validation_curve', 'plot_learning_curve', 'plot_capacity']
